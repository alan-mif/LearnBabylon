export class MeshBuilder {
    ...
    private _init(): void {
        ...
        const box = BABYLON.MeshBuilder.CreateBox('box', { height: 5, width: 2, depth: 0.5 }, scene), // 参数1 mesh name，参数2 box 的一些参数，这里传入空对象，让其使用默认值，参数3传入 scene
            ground = BABYLON.MeshBuilder.CreateGround("myGround", { width: 6, height: 4, subdivisions: 4 }, scene),
            myPoints = [
